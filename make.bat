...
SET MASM="C:\Program Files\Microsoft Visual Studio\2022\Professional\VC\Tools\MSVC\14.40.33807\bin\Hostx64\x86\"
SET INCLUDE=C:\users\WarrenJo\source\Irvine32
SET LIB=C:\users\WarrenJo\source\Irvine32
REM **************************** End of customized lines

REM Invoke ML.EXE (the assembler):

%MASM%ML /nologo -c -omf -Fl -Zi %1
if errorlevel 1 goto terminate

REM Run the 16-bit linker, modified for Visual Studio:

C:\users\WarrenJo\source\Irvine32\LINK16 %1,,NUL,Irvine16 /CODEVIEW;
if errorlevel 1 goto terminate
